...
extern diag_object_t diag_vector_ref(diag_vector_t *v, diag_size_t k);

extern void diag_vector_set(diag_vector_t *v, diag_size_t k, diag_object_t e);

extern void diag_vector_fill(diag_vector_t *v, diag_object_t fill);
