...
DIAG_FUNCTION diag_size_t diag_rbtree_insert(struct diag_rbtree *tree, struct diag_rbtree_node *node);

DIAG_FUNCTION diag_size_t diag_rbtree_delete(struct diag_rbtree *tree, struct diag_rbtree_node *node);
